...
def print_menu(table):
    ...
    5 - Lật bài {"(chưa chia bài)" if table.state != controller.TABLE_STATE_SUFFER else "(có thể chia bài)"}
...
def menu():
    ...
    for i in range(number_players):
        ...
        init_number_players.append(controller.add_new_user())

    table = controller.init_table(init_number_players)
    ...
    while True:
        ...
        if user_input == 1:
            ...
            table.add_player(controller.add_new_user())
